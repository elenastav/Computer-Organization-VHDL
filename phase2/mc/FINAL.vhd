...
component DATAPATH is
	...
	signal Instr_Reg_tmp : STD_LOGIC;
	signal MEM_Reg_tmp : STD_LOGIC;
	signal rfA_Reg_tmp : STD_LOGIC;
	signal rfB_Reg_tmp : STD_LOGIC;
	signal ALU_Reg_tmp : STD_LOGIC;
...
begin
	...
	port map(Clk => Clk,
	          ...
	          Instr => Instr_tmp,
				 ...
				 Instr_Reg_WrEn => Instr_Reg_tmp,
				 MEM_Reg_WrEn => MEM_Reg_tmp,
				 rfA_Reg_WrEn => rfA_Reg_tmp,
				 rfB_Reg_WrEn => rfB_Reg_tmp,
				 ALU_Reg_WrEn => ALU_Reg_tmp
				);
